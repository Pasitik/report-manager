      ...
      <GridItem xs={12} sm={12} md={4}>
          <Card>
            <CardHeader color="danger" stats icon>
              ...
              <p className={classes.cardCategory} align="center"> A robbery was just reported!</p><br/>
        ...
        <GridItem xs={12} sm={12} md={4}>
          <Card>
            <CardHeader color="danger" stats icon>
              ...
              <p className={classes.cardCategory} align="center"> An accident was just reported!</p><br/>
              <Button color="secondary"> View Location on Map </Button>
            </CardHeader>
            <CardFooter stats>
              <div className={classes.stats}>
